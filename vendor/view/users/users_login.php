<div class="row animate slideIn">
    ...
    <div class="col-md-4 mx-auto">
        ...
        <div class="text-right mt-3">
            ...
            <button type="button" class="btn btn-outline-primary" onclick="request('FOLDER=VIEW&PRODUCT=GR&TABLE=CONFIG&ACTION=CONFIG_FORM')">

                <i class="fas fa-cog mr-1"></i>Configurações <strong>Iniciais</strong>
