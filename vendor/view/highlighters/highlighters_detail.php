        ...
        <div class="card">
            ...
            <div class="card-body">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h5>
                                                ...
                                                <strong>
                                                    ...
                                                    <?php echo utf8_encode(date('d/m/Y', strtotime(@(string)$resultHighlighters->date)))?>
                ...
                <div class="vertical-timeline vertical-timeline--animate vertical-timeline--one-column">
                    ...
                    /** Listagem de Itens */
                    foreach (json_decode(base64_decode($resultHighlighters->history), true) as $keyResult => $result)
                    { ?>
