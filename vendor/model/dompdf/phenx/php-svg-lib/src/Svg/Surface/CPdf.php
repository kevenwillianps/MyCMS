...
class CPdf
{
    ...
    /**
     * @var string The encryption key for the encryption of all the document contents (structure is not encrypted)
     */
...
//      }
            ...
            case 'out':
                ...
                if (!$compressed && isset($o['raw'])) {
                    ...
                    if (!$compressed && $this->compressionReady && $this->options['compression']) {
                        // then implement ZLIB based compression on this contents stream
                        $compressed = true;
            ...
            case 'out':
                ...
                if ($count == 1) {
                    ...
                    if ($count > 1) {
                        ...
                        // reverse the page contents so added objects are below normal contents
    ...
    /**
     * the contents objects hold all of the contents which appears on pages
     */
    ...
    /**
     * add contents to the currently active object
     */
    ...
    function stream($options = '')
    {
        ...
        // 'compress' = > 1 or 0 - apply contents stream compression, this is on (1) by default
        ...
        //FIXME: I don't know that this is sufficient for determining contents length (i.e. what about transport compression?)
    ...
    function openObject()
    {
        ...
        // add a new object of the contents type, to hold the data flow
        $this->numObj++;
        $this->o_contents($this->numObj, 'new');
        $this->currentContents = $this->numObj;
            ...
            switch ($options) {
                ...
                case 'add':
                    if (isset($this->objects[$this->currentContents]['onPage'])) {
                        ...
                        $this->o_page($this->objects[$this->currentContents]['onPage'], 'contents', $id);
                    }
                    break;
    ...
    /**
     * add contents to the documents info object
     */
