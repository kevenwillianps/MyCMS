...
class Block extends AbstractFrameReflower
{
        ...
        if ($diff > 0) {
            if ($absolute) {
                ...
                if ($width === "auto" && $left === "auto" && $right === "auto") {
                    ...
                    // preferred width of the contents...  a little too costly here as a
    ...
    /**
     * Determine the unrestricted height of contents within the block
    ...
    protected function _calculate_restricted_height()
    {
        ...
        if ($frame->is_absolute()) {
            ...
            // Only handle min/max height if the height is independent of the frame's contents
