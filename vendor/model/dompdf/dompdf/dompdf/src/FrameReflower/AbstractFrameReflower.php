...
abstract class AbstractFrameReflower
{
    ...
    function get_min_max_width()
    {
        ...
        // contents.  If the width is a percentage ignore it for now.
        $width = $style->width;
    ...
    /**
     * Parses the CSS "contents" property
     *
    ...
    /**
     * Sets the generated contents of a generated frame
     */
    protected function _set_content()
    {
        ...
        if ($style->content && $frame->get_node()->nodeName === "dompdf_generated") {
            ...
            // add generated contents to the font subset
