...
class Stylesheet
{
     ...
     * Therefore allow specification of contents by dompdf setting Options::defaultMediaType.
            ...
            switch ($s) {
                ...
                case ":":
                    ...
                    switch ($tok) {
                        ...
                        default:
                            $query = "/../.."; // go up two levels because generated contents starts on the body element
                            $tok = "";
                            break;
                    }
    ...
    function apply_styles(FrameTree $tree)
    {
        ...
        foreach ($this->_styles as $selector => $selector_styles) {
            ...
            foreach ($selector_styles as $style) {
                ...
                // Retrieve the nodes, limit to body for generated contents
                ...
                foreach ($nodes as $node) {
                    ...
                    foreach (array_keys($query["pseudo_elements"], true, true) as $pos) {
                        ...
                        if (($src = $this->_image($style->get_prop('contents'))) !== "none") {
