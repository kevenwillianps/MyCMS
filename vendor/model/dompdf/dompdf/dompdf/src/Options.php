...
class Options
{
     ...
     * the desired contents might be different (e.g. screen or projection view of html file).
     * Therefore allow specification of contents here.
     *
     * @var string
     */
     ...
     * This allows anonymous users to download legally doubtful internet contents which on
