...
class Page extends AbstractFrameDecorator
{
     ...
     *    3. Between the contents edge of a block container box and the
     *    outer edges of its child contents (margin edges of block-level
     ...
     * contents from overflowing the page boxes, then rules B and D are
    ...
    protected function _page_break_allowed(Frame $frame)
    {
        ...
        if (in_array($display, $block_types)) {
            ...
            if (in_array($display, Style::$INLINE_TYPES)) {
                ...
                // some contents is on the page before splitting.
                $prev = $frame->get_prev_sibling();
