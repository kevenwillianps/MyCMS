...
abstract class AbstractFrameDecorator extends Frame
{
    ...
    public $_counters = array(); // array([id] => counter_value) (for generated contents)
    ...
    function split(Frame $child = null, $force_pagebreak = false)
    {
        ...
        if (is_null($child)) {
            // check for counter increment on :before contents (always a child of the selected element @link AbstractFrameReflower::_set_content)
