...
//    if ( $this->_frame->get_style()->contents !== "normal" ) {
//      $this->_frame->get_node()->data = $this->_frame->get_style()->contents;
//      $this->_frame->get_style()->contents = "normal";
//    }
...
//      Helpers::pre_r("width: " . $this->_dompdf->getFontMetrics()->getTextWidth($text, $style->font_family, $style->font_size));
     ...
     * start at the top and bottom of the contents area, not the
