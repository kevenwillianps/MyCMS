...
#yours {background-color: hsl(220,10%,220%);background-color: hsla(220,10%,220%,.3);}', $oDoc->render());
	...
	function testUnicodeParsing() {
		...
		foreach ($oDoc->getAllDeclarationBlocks() as $oRuleSet) {
			...
			$aContentRules = $oRuleSet->getRules('contents');
...
.collapser::before, .collapser::-moz-before, .collapser::-webkit-before {contents: "»";font-size: 1.2em;margin-right: .2em;-moz-transition-property: -moz-transform;-moz-transition-duration: .2s;-moz-transform-origin: center 60%;}
...
body {background-url: url("http://somesite.com/images/someimage.gif");}';
	...
	*/
	...
	function testIeHacksParsing() {
		...
		$sExpected = 'p {padding-right: .75rem \9;background-image: none \9;color: red \9\0;background-color: red \9\0;background-color: red \9\0 !important;contents: "red 	\0";contents: "red઼";}';
